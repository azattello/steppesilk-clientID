...
const Sidebar = ({ onNavItemClick }) => {
    ...
    // const [burgerActive, setBurgerActive] = useState(() => sessionStorage.getItem('burgerActive') === 'true');
    ...
    //   useEffect(() => {
    //     // Сохраняем burgerActive в sessionStorage при его изменении
    //     sessionStorage.setItem('burgerActive', burgerActive);
        
    //     // Получаем ссылку на элемент sidebar
    //     const sidebarElement = document.getElementById("sidebar");
        
    //     // Устанавливаем или удаляем класс в зависимости от значения burgerActive
    //     if (burgerActive) {
